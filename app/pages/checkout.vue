                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" placeholder="+90 (5__) ___ __ __" />
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea class="form-input textarea"
                                placeholder="Enter neighborhood, street, avenue and other information"></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="payment-layout">
                        <div class="payment-form">
                            <div class="form-group full-width">
                                ...
                                <input type="text" class="form-input" v-model="cardForm.holderName"
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" v-model="cardForm.expiryDate"
                                        placeholder="MM / YY" maxlength="5" @input="formatExpiryDate" />
                                </div>
                                <div class="form-group">
                                    <label>CVV *</label>
                                    <div class="cvv-wrapper">
                                        <input type="text" class="form-input" v-model="cardForm.cvv" maxlength="3" />
                        ...
                        <div class="visual-card">
                            ...
                            <div class="card-details">
                                <div class="card-holder">
                                    ...
                                    <strong>{{ cardForm.holderName || 'CARD HOLDER' }}</strong>
                                </div>
                                <div class="card-cvv">
                                    <span>CVV</span>
                                    <strong>{{ cardForm.cvv || 'XXX' }}</strong>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <strong style="color: #333; font-size: 14px;">{{ cardForm.expiryDate || 'MM / YY'
                                    }}</strong>
                            </div>
